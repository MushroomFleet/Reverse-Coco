<a target="_blank" href="https://colab.research.google.com/github/MushroomFleet/Reverse-Coco/blob/main/ReverseCocoV1.ipynb">
  <img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/>
</a>

# Reverse-Coco
using python we can interrogate Coco Model to draw out image descriptions if a match is found.

![alt text](https://github.com/MushroomFleet/Reverse-Coco/blob/main/reverse-coco.png?raw=true)
